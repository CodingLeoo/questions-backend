...
export const USER_LOGIN_DESCRIPTION = (username: string, date: string, hour: string) => `${username} has been logged in on ${date} at ${hour}.`;

export const USER_LOGOUT_ACTIVITY = "User Log-out";
export const USER_LOGOUT_DESCRIPTION = (username: string, date: string, hour: string) =>  `${username} has been logged out on ${date} at ${hour}.`;